...
TRIANGLE_BRIDGES: List[str] = ["BTC", "ETH", "USDC"]  # НОВОЕ (по прямому
    # запросу пользователя — "добавим все") — USDC работает на обеих
    # биржах универсально, в отличие от KCS/MX (специфичны только для
    # одной биржи каждый, потребовали бы отдельной логики).
